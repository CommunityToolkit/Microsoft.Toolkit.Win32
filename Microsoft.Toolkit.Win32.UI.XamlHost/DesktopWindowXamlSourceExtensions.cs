...
{
    /// <summary>
    /// COM wrapper required to access native-only methods on <see cref="uwpXaml.Hosting.DesktopWindowXamlSource" />
    /// </summary>
    public static class DesktopWindowXamlSourceExtensions
    {
        /// <summary>
        /// Gets the <see cref="IDesktopWindowXamlSourceNative" /> interface from a <see cref="uwpXaml.Hosting.DesktopWindowXamlSource" /> instance.
        /// </summary>
        ...
        /// </remarks>
        public static IDesktopWindowXamlSourceNative GetInterop(this uwpXaml.Hosting.DesktopWindowXamlSource desktopWindowXamlSource)
        {
